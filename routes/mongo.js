...
router.post('/updateTemp', async (req, res) => {
    ...
    let taste = (parseInt(req.body.symptomOne) === 1 || req.body.symptomOne.includes('y'));
    let cough = (parseInt(req.body.symptomTwo) === 1 || req.body.symptomTwo.includes('y'));
    let fever = (parseInt(req.body.symptomThree) === 1 || req.body.symptomThree.includes('y'));
    let evacuation = (parseInt(req.body.symptomFour) === 1 || req.body.symptomFour.includes('y'));
